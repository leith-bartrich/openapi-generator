...
class OPENAPI_API UOAPIModel : public UObject
{
    GENERATED_BODY()
...
*/
    ...
    inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, UOAPIModel* Value)
    {
...
*/
    ...
    inline void WriteJsonValue(JsonWriter& Writer, const FString& Value)
    {
